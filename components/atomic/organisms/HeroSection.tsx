    ...
    <section id="home" className={`relative min-h-[70vh] flex items-center justify-center overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          ...
          <div className="text-white text-lg md:text-2xl max-w-2xl mt-2">
            <TextAnimate animation="blurInUp" by="word" duration={1} delay={1.2}>
              {t('subheadline')}
            </TextAnimate>
          </div>
          ...
          <motion.button
            ...
            animate={{
              scale: [1, 1.08, 1],
              boxShadow: [
                '0 0 0px 0px rgba(236, 116, 36,0.5)',
                '0 0 16px 4px rgba(236, 116, 36,0.7)',
                '0 0 0px 0px rgba(236, 116, 36,0.5)'
              ]
            }}
            transition={{
